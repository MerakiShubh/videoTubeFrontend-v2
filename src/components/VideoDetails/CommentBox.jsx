...
function CommentBox({ videoId }) {
  ...
  return (
    <div className="w-full">
      ...
      <div
        className={`fixed inset-x-0 bottom-0 z-[60] h-[calc(100%-69px)] overflow-auto rounded-t-lg border bg-[#0e0e0e] p-4 transition-transform duration-300 sm:static sm:h-auto sm:max-h-[500px] sm:transform-none lg:max-h-none ${
